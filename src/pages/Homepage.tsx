...
export default function Home() {
  ...
  return (
    <>
      <Seo
        title="MindWell - Nền tảng tư vấn sức khỏe tinh thần trực tuyến"
        description="MindWell - Nền tảng tư vấn sức khỏe tinh thần trực tuyến hàng đầu Việt Nam. Kết nối bạn với các chuyên gia tâm lý, bác sĩ tâm thần uy tín. Chăm sóc tâm trí, mọi lúc, mọi nơi."
        canonicalPath="/"
        ogType="website"
      />
          ...
          <div className="relative grid grid-cols-1 gap-7 p-6 md:grid-cols-[1.15fr_0.85fr] md:p-10">
            <div className="min-w-0">
              ...
              <p className="mt-4 max-w-xl text-[13px] font-semibold leading-7 text-white/90">
                Chăm sóc tâm trí, mọi lúc, mọi nơi. Kết nối với chuyên gia tâm
                lý uy tín, tư vấn trực tuyến an toàn và bảo mật tuyệt đối.
              </p>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-[12px] font-semibold leading-6 text-white/90">
              ...
              đồng hành cùng bạn trên con đường tìm lại sự bình yên và hạnh
              phúc.
            </p>
